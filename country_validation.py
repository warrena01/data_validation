...
class CoordinateValidationTool(QMainWindow):
    ...
    def initUI(self):
        ...
        self.label8.setGeometry(30, 490, 300, 20)

        self.btn5 = QPushButton('Go', self)
        self.btn5.setGeometry(30, 520, 100, 30)
        ...
        self.exit_btn.setGeometry(30, 550, 100, 30)  # Position the button at the top-right corner
